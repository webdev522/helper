!(function () {
  ...
  function createMenu() {
    ...
    firstRow.style.cssText = "display: flex;";
    ...
    secondRow.style.cssText = "display: flex;";
    ...
    secondRow.appendChild(fontElement);
    secondRow.appendChild(heightElement);

    // content - third
    const thirdRow = document.createElement("div");
    thirdRow.style.cssText = "display: flex;";
    ...
    thirdRow.appendChild(readerElement);
    thirdRow.appendChild(colorElement);

    contentContainer.appendChild(firstRow);
    contentContainer.appendChild(secondRow);
    contentContainer.appendChild(thirdRow);
